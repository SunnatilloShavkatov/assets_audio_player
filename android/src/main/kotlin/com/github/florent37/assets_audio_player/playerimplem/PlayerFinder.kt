...
object PlayerFinder {
    ...
    private val playerImpls = listOf(
    ...
    private fun sortPlayerImpls(
        path: String?,
        originList: List<PlayerImplemTester>
    ): List<PlayerImplemTester> {
    ...
    private fun <T> MutableList<T>.moveToFirst(element: T) = this.apply {
        remove(element)
